...
public final class ActivityItemComvergesBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityItemComvergesBinding(@NonNull ScrollView rootView, @NonNull Button addToCart,
      @NonNull Button addToWishlist, @NonNull TextView descriptionHeader,
      @NonNull TextView descriptionText, @NonNull TextView display, @NonNull ImageView productImage,
  ...
  @NonNull
  public static ActivityItemComvergesBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityItemComvergesBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_item_comverges, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityItemComvergesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityItemComvergesBinding((ScrollView) rootView, addToCart, addToWishlist,
          descriptionHeader, descriptionText, display, productImage, productName, productPrice);
    }
