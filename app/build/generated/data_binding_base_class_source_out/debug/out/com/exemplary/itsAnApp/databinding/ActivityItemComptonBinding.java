...
public final class ActivityItemComptonBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityItemComptonBinding(@NonNull ScrollView rootView, @NonNull Button addToCart,
  ...
  @NonNull
  public static ActivityItemComptonBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityItemComptonBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_item_compton, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityItemComptonBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityItemComptonBinding((ScrollView) rootView, addToCart, addToWishlist,
