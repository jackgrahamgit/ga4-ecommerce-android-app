...
public final class ActivityItemFlexigenBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityItemFlexigenBinding(@NonNull ScrollView rootView, @NonNull Button addToCart,
  ...
  @NonNull
  public static ActivityItemFlexigenBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityItemFlexigenBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_item_flexigen, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityItemFlexigenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityItemFlexigenBinding((ScrollView) rootView, addToCart, addToWishlist,
